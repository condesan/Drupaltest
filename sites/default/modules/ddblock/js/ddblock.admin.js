// $Id: ddblock.admin.js,v 1.5.2.2 2009/09/16 03:35:02 ppblaauw Exp $
...
Drupal.behaviors.ddblockShowHidePager2Options = function(context) {
  ...
  $('#ddblock-instance-settings #edit-pager2:not(.ddblock-show-hide-pager2-options-processed)', context)
  ...
  // Show/hide prev/next pager options depending on the checkbox.
  $('#ddblock-block-settings #edit-pager2:not(.ddblock-show-hide-pager2-options-processed)', context)
  .addClass('ddblock-show-hide-pager2-options-processed')
  .bind("click change", function(){
    if (this.checked) {
      $("#ddblock-pager2-settings-wrapper").show();
...
Drupal.behaviors.ddblockShowHidePager2PagerOptions = function(context) {
  // Show/hide pager options depending on the checkbox.
  $('#ddblock-instance-settings #edit-pager2-position-pager:not(.ddblock-show-hide-pager2-pager-options-processed)', context)
  ...
  // Show/hide pager options depending on the checkbox.
  $('#ddblock-block-settings #edit-pager2-position-pager:not(.ddblock-show-hide-pager2-pager-options-processed)', context)
  .addClass('ddblock-show-hide-pager2-pager-options-processed')
  .bind("click change", function(){
    if (this.checked) {
      $("#ddblock-pager2-pager-settings-wrapper").show();
...
Drupal.behaviors.ddblockShowHidePager2SlideOptions = function(context) {
  // Show/hide pager options depending on the checkbox.
  $('#ddblock-instance-settings #edit-pager2-position-slide:not(.ddblock-show-hide-pager2-slide-options-processed)', context)
  ...
  // Show/hide pager options depending on the checkbox.
  $('#ddblock-block-settings #edit-pager2-position-slide:not(.ddblock-show-hide-pager2-slide-options-processed)', context)
  .addClass('ddblock-show-hide-pager2-slide-options-processed')
  .bind("click change", function(){
    if (this.checked) {
      $("#ddblock-pager2-slide-settings-wrapper").show();
...
Drupal.behaviors.ddblockShowHideCustomTemplateOptions = function(context) {
  ...
  .bind("change", function() {
    ...
    case "custom" :
      ...
      $("#ddblock-pager-settings-wrapper").show();
      $("#edit-pager-toggle-wrapper").show();
    case "upright10" :
      $('#edit-pager-wrapper #edit-pager').val('number-pager');
      $('#edit-pager-container').val('.custom-pager-item');
      ...
      $('#edit-pager-wrapper option[value="custom-pager"]').hide();
      $('#edit-pager-wrapper option[value="scrollable-pager"]').hide();
      $("#ddblock-pager-settings-wrapper").show();
      $("#edit-pager-toggle-wrapper").show();
    break;
    case "upright20" :
      ...
      $('#edit-pager-wrapper option[value="scrollable-pager"]').hide();
     $("#ddblock-pager-settings-wrapper").hide();
     $("#edit-pager-toggle-wrapper").hide();
    break;
    case "upright30" :
    case "upright40" :
    case "upright50" :
    ...
    break;
    case "upright60" :
      $('#edit-pager-wrapper #edit-pager').val('scrollable-pager');
      $('#edit-pager-container').val('.scrollable-pager-item');
      $('#edit-pager-wrapper option[value="number-pager"]').hide();
      $('#edit-pager-wrapper option[value="prev-next-pager"]').hide();
      $('#edit-pager-wrapper option[value="custom-pager"]').hide();
      $('#edit-pager-wrapper option[value="scrollable-pager"]').show();
      $("#ddblock-pager-settings-wrapper").show();
      $("#edit-pager-toggle-wrapper").show();
    break;
    }
